#Taken from - https://gist.github.com/EricEzaM/4909a62d7c31d2a4cab685382cdae87e
#by https://gist.github.com/EricEzaM
tool
extends Container
...
func _notification(p_what):
	match p_what:
		NOTIFICATION_SORT_CHILDREN:		
			...
			var min_columns = int(floor(rect_size.x / (get_child(0).get_combined_minimum_size().x + hsep)))
			self.columns = min_columns if min_columns > 0 else 1
